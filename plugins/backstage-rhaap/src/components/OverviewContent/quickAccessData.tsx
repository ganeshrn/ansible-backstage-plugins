...
export const learn: IQuickAccessLinks = {
  ...
  description: (
    <div>
      ...
      New and experienced users alike can get up-to-speed with learning paths
      based on the latest Ansible Automation Platform versions and best
      practices.
      <br />
      Please visit the&nbsp;
...
export const discoverContent: IQuickAccessLinks = {
  ...
  description:
    'Leverage existing collections and execution environments from Automation Hub. Private Automation Hub is a self-hosted Ansible content management system. Organizations can host private hubs on their own infrastructure and manage it themselves.',
  showButton: true,
  button: {
...
export const create: IQuickAccessLinks = {
  name: 'Create',
  description:
    'Create new Git projects with a single, clear, opinionated method to accomplish a specific task.',
  showButton: true,
  button: {
...
export const develop: IQuickAccessLinks = {
  ...
  description: (
    <div>
      Develop with Ansible Development Workspaces. Ansible development ready
      cloud environment with VSCode.
      <br />
      You can also use our&nbsp;
      <Link to="https://marketplace.visualstudio.com/items?itemName=redhat.ansible">
        Visual Studio Code Extension instead.{' '}
        <OpenInNew fontSize="small" style={{ fontSize: '14px' }} />
      </Link>
    </div>
  ),
